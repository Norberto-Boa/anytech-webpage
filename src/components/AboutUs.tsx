    ...
    <div className="py-24 bg-white w-full px-auto">
      <div className="lg:max-w-5xl md:max-w-2xl sm:max-w-xl xs:max-w-sm mx-auto px-auto flex justify-between gap-12 items-stretch lg:flex-row flex-col">
        <div className="lg:w-[48%] sm:max-w-xl xs:max-w-sm max-w-xs flex-none items-center mx-auto">
          ...
          <p className="flex gap-2 pb-2"><CheckFat className="text-sky-500 flex-none mt-1" weight="fill"/> <div className="text-zinc-500"><strong className="text-zinc-900">Comprometimento:</strong> Temos como meta, entregar sempre os projectos a dentro do prazo.</div></p>
          <p className="flex gap-2 pb-8"><CheckFat className="text-sky-500 flex-none mt-1" weight="fill"/> <div className="text-zinc-500"><strong className="text-zinc-900">Paixão:</strong> Fazemos os nossos trabalhos sempre com a componente amor.</div></p>
